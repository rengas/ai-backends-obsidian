...
var SummarizeOperation = class {
  ...
  async execute(editor, text, settings) {
    ...
    if (!config || !config.summarize) {
      new import_obsidian3.Notice("Please configure the summarize settings in the YAML file first");
      return;
    }
    if (!settings.apiUrl) {
      new import_obsidian3.Notice("Please set the API URL in settings");
      return;
    }
    try {
      const requestBody = {
...
**Summary:**
 ...
 ${result.summary}`);
        new import_obsidian3.Notice("Text summarized successfully");
      }
    } catch (error) {
      console.error("Error summarizing text:", error);
      new import_obsidian3.Notice("Error summarizing text. Please check your API settings.");
    }
  }
};
...
var TranslateOperation = class {
  ...
  async execute(editor, text, settings, customTargetLanguage) {
    ...
    if (!config || !config.translate) {
      new import_obsidian4.Notice("Please configure the translate settings in the YAML file first");
      return;
    }
    if (!settings.apiUrl) {
    ...
    if (!targetLanguage) {
      new import_obsidian4.Notice("Please specify a target language in the config file or provide one");
      return;
    }
    try {
      const requestBody = {
...
${result.translation}`);
        new import_obsidian4.Notice("Text translated successfully");
      }
    } catch (error) {
      console.error("Error translating text:", error);
      new import_obsidian4.Notice("Error translating text. Please check your API settings.");
    }
  }
};
...
var KeywordsOperation = class {
  ...
  async execute(editor, text, settings) {
    ...
    if (!config || !config.keywords) {
      new import_obsidian5.Notice("Please configure the keywords settings in the YAML file first");
      return;
    }
    if (!settings.apiUrl) {
...
**Keywords:**
${keywordsList}`, cursor);
      new import_obsidian5.Notice("Keywords extracted successfully");
    } catch (error) {
      console.error("Error extracting keywords:", error);
      new import_obsidian5.Notice("Error extracting keywords. Please check your API settings.");
    }
  }
};
...
var RewriteOperation = class {
  ...
  async execute(editor, text, instruction, headerLabel, settings) {
    const config = this.configService.getConfig();
    if (!config || !config.rewrite) {
      new import_obsidian6.Notice("Please configure the rewrite settings in the YAML file first");
      return;
    }
    if (!settings.apiUrl) {
...
${output}`);
        new import_obsidian6.Notice("Action applied successfully");
      }
    } catch (error) {
      console.error("Error applying rewrite:", error);
      new import_obsidian6.Notice("Error applying action. Please check your API settings.");
    }
  }
...
var ContextMenuManager = class {
  constructor(summarizeOperation, translateOperation, keywordsOperation, rewriteOperation, settings) {
    this.tones = TONES;
  ...
  setupContextMenu(menu, editor, view) {
    const selection = editor.getSelection();
    if (selection.length > 0) {
      menu.addItem((item) => {
        item.setTitle("AI Backends").setIcon("brain-circuit").setSection("selection");
        const subMenu = item.setSubmenu();
        subMenu.addItem((subItem) => {
          subItem.setTitle("Summarize").setIcon("document-text").onClick(async () => {
            await this.summarizeOperation.execute(editor, selection, this.settings);
          });
        });
        subMenu.addItem((subItem) => {
          subItem.setTitle("Extract Keywords").setIcon("tag").onClick(async () => {
            await this.keywordsOperation.execute(editor, selection, this.settings);
          });
        });
        subMenu.addItem((subItem) => {
          subItem.setTitle("Improve description").setIcon("file-text").onClick(async () => {
            await this.rewriteOperation.improveDescription(editor, selection, this.settings);
          });
        });
        subMenu.addItem((subItem) => {
          subItem.setTitle("Improve writing").setIcon("wand").onClick(async () => {
            await this.rewriteOperation.improveWriting(editor, selection, this.settings);
          });
        });
        subMenu.addItem((subItem) => {
          subItem.setTitle("Fix spelling & grammar").setIcon("check").onClick(async () => {
            await this.rewriteOperation.fixSpellingGrammar(editor, selection, this.settings);
          });
        });
        subMenu.addItem((subItem) => {
          subItem.setTitle("Brainstorm").setIcon("lightbulb").onClick(async () => {
            await this.rewriteOperation.brainstorm(editor, selection, this.settings);
          });
        });
        subMenu.addItem((subItem) => {
          subItem.setTitle("Make shorter").setIcon("minus").onClick(async () => {
    ...
    const baseCommands = [
      {
        ...
        editorCallback: async (editor, view) => {
          ...
          if (selection.length > 0) {
            ...
            new import_obsidian7.Notice("Please select some text to summarize");
          }
        }
      },
      {
        ...
        editorCallback: async (editor, view) => {
          ...
          if (selection.length > 0) {
            ...
            new import_obsidian7.Notice("Please select some text to extract keywords from");
          }
        }
      },
      {
        ...
        editorCallback: async (editor, view) => {
          ...
          if (selection.length > 0) {
            ...
            new import_obsidian7.Notice("Please select some text to translate");
          }
        }
      },
      {
        ...
        editorCallback: async (editor, view) => {
          ...
          if (selection.length > 0) {
            ...
            new import_obsidian7.Notice("Please select some text to improve");
          }
        }
      },
      {
      ...
      },
      {
        ...
        editorCallback: async (editor, view) => {
          ...
          if (selection.length > 0) {
            ...
            new import_obsidian7.Notice("Please select some text to correct");
          }
        }
      },
      {
        ...
        editorCallback: async (editor, view) => {
          ...
          if (selection.length > 0) {
            ...
            new import_obsidian7.Notice("Please select some text to brainstorm on");
          }
        }
      },
      {
        ...
        editorCallback: async (editor, view) => {
          ...
          if (selection.length > 0) {
            ...
            new import_obsidian7.Notice("Please select some text to shorten");
          }
        }
      }
    ];
...
var AIPluginSettingTab = class extends import_obsidian8.PluginSettingTab {
  ...
  display() {
    ...
    new import_obsidian8.Setting(containerEl).setName("API URL").setDesc("Enter the base URL for the AI API (e.g., http://localhost:3000)").addText((text) => text.setPlaceholder("http://localhost:3000").setValue(this.plugin.settings.apiUrl).onChange(async (value) => {
      this.plugin.settings.apiUrl = value;
      await this.plugin.saveSettings();
    }));
    new import_obsidian8.Setting(containerEl).setName("Configuration File Path").setDesc("Full path to the YAML configuration file (relative to vault root)").addText((text) => text.setPlaceholder("ai-config/config.yaml").setValue(this.plugin.settings.configFilePath).onChange(async (value) => {
