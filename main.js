...
var SummarizeOperation = class {
  constructor(aiService, streamingService) {
...
var ImportFileModal = class extends import_obsidian11.Modal {
  ...
  onOpen() {
    ...
    const files = this.app.vault.getFiles().filter(
      (file) => file.name.endsWith(`.${this.extension}`) && file.path.startsWith("ai-backends/")
    );
    if (files.length === 0) {
